...
不要用第一人称，不要煽情，不要像系统任务说明。
必须自然分成四段，但不要写“一、二、三、四”或“第一部分”：
1. 交代玩家第一次遇到${currentName}的时间、年龄或人生阶段。
2. 交代玩家带来的20%变数：除了${currentName}自身行为，也要写到身边人的结局边缘、误会、信件、演出现场或某个旁人的选择被轻微改变。不能改变大历史。
3. 抛给玩家一个反思问题。问题必须关于“你和音乐家的关系”“你对音乐家的看法”或“你对时间穿梭的看法”，不是剧情问题。例如“你究竟是在安慰他，还是在借他安慰自己？”
4. 结尾告诉玩家：你们会在下一个时空相遇。语气冷静，像档案结案，不要浪漫化。
