...
function fallbackPlaylist(date) {
  ...
  return {
    ...
    songs: [
      ...
      ['山丘','李宗盛','山丘',2013,'中文','中文当代','金曲奖年度歌曲级别讨论','越过山丘见自己','沧桑,释然','越过山丘'],
      ['如愿','王菲','我和我的父辈',2021,'中文','中文当代','主流影视歌曲现象级传播','愿光替你抵达','温暖,家国','你是遥遥的路'],
      ['浮夸','陈奕迅','U87',2005,'中文','中文经典','香港金曲与粤语流行讨论经典','把孤独唱成火','戏剧,锋利','你当我是浮夸吧'],
      ['刻在我心底的名字','卢广仲','刻在你心底的名字',2020,'中文','中文当代','金马奖最佳原创电影歌曲','把遗憾藏进光','青春,怅然','刻在我心底的名字'],
      ['Billie Jean','Michael Jackson','Thriller',1983,'英文','英文经典','格莱美获奖与流行工业标杆','月光下别回头','律动,悬疑','Billie Jean is not'],
      ['Like a Prayer','Madonna','Like a Prayer',1989,'英文','英文经典','发行时引发宗教与流行文化热议','圣光里有叛逆','神圣,反叛','Like a prayer'],
      ['Rolling in the Deep','Adele','21',2010,'英文','英文当代','格莱美年度制作与年度歌曲','伤口敲成战鼓','爆发,决绝','Rolling in the deep'],
      ['Royals','Lorde','Pure Heroine',2013,'英文','英文当代','格莱美年度歌曲，引发反奢华流行讨论','把皇冠放低','冷感,锋利','We will never be royals'],
      ['Viva La Vida','Coldplay','Viva La Vida or Death and All His Friends',2008,'英文','英文经典','格莱美年度歌曲并长期流行','王冠落入钟声','史诗,明亮','I used to rule'],
      ['bad guy','Billie Eilish','When We All Fall Asleep, Where Do We Go?',2019,'英文','英文当代','格莱美年度制作与年度歌曲','黑暗也会眨眼','怪诞,俏皮','I am the bad guy']
    ].map((s, i) => ({
